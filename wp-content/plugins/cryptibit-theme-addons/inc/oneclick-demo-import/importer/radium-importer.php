 ...
 if ( !class_exists( 'Radium_Theme_Importer' ) ) {
	...
	class Radium_Theme_Importer {
			...
			?>
			 ...
			 <div class="theme-demo-import-items">
				 ...
				 <div class="theme-demo-import-item">
					 ...
					 <input type="radio" name="theme_demo" value="1" checked>1 - Main<br>
					 </div>
					 ...
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/cryptibit/cryptibit-1/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="2">2 - Blockchain company<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/2/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/cryptibit/cryptibit-2/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="3">3 - App landing page<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/3/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/cryptibit/cryptibit-3/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="4">4 - Crypto agency<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/4/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/cryptibit/cryptibit-4/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="5">5 - ICO & IEO onepage<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/5/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/cryptibit/cryptibit-5/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="6">6 - Cryptocurrency blog<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/6/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/cryptibit/cryptibit-6/" target="_blank">Live preview</a>
					 </div>
				 </div>
	    ...
	    public function demo_installer() {
	        ...
	        <h2>One Click CryptiBIT Theme Demo Data import</h2>

			<?php if((get_option( 'cryptibit_license_key_status', false ) !== 'activated')&&(!defined('ENVATO_HOSTED_SITE'))): ?>
			...
			<div class="radium-importer-wrap">
		        <div class="theme-important-notice">
			 	<p>Please register your purchase to import theme demos, get themes updates notifications and get access to premium dedicated support. Theme registration is free and will take just 30 seconds.</p>
	          	...
	          	<a href="themes.php?page=ipanel_CRYPTIBIT_PANEL" class="button button-hero button-primary">Theme registration</a>
	          	<br/><br/>
				</div>
			</div>
