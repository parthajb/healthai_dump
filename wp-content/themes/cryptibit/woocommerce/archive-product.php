...
if ( defined('DEMO_MODE') && isset($_GET['woocommerce_sidebar_position']) ) {
  $cryptibit_theme_options['woocommerce_sidebar_position'] = $_GET['woocommerce_sidebar_position'];
}

if(isset($cryptibit_theme_options['woocommerce_sidebar_position'])) {
	$page_sidebarposition = $cryptibit_theme_options['woocommerce_sidebar_position'];
} else {
...
if(!is_product_category() && isset($cryptibit_theme_options['shop_page_title_image']) && $cryptibit_theme_options['shop_page_title_image'] <> '') {
  $header_background_image_style = 'background-image: url('.$cryptibit_theme_options['shop_page_title_image'].');';
